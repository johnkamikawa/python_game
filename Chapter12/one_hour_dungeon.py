...
RED   = (255,   0,   0)
CYAN  = (  0, 255, 255)
BLINK = [(224,255,255), (192,240,255), (128,224,255), (64,192,255), (128,225,255), (192,240,255)]
...
EMY_NAME = [
	"Green Slime", "Red Slime", "Axe Beast", "Ogre", "Swordsman",
...
def draw_battle(bg, fnt): # 先頭画面の描画
	...
	for i in range(10): # 先頭メッセージの表示
		draw_text(bg, message[i], 600, 100+i*50, fnt, WHITE)
	draw_para(bg, fnt) # 主人公の能力表示
